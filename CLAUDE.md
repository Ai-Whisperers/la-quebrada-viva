...
> - `docs/wesley_brief_onepager.md` → moved to `docs/people/`. Same for `4ENTITY_BV_CASCADE.md`, `post_escritura_one_pager.md` (renamed).
...
> - Pass 3 archive additions: `docs/patches/` (2 files, patches already applied), `docs/REPO_STRUCTURE.md` (stale), `docs/MASTER_TODO.md` → stub, `docs/T_PLUS_1_DEBRIEF.md`, `docs/PR_BACK_TO_BASE.md`, `docs/GAPS_ANALYSIS.md`, `docs/_reconciled/IDEAS_CATALOG_PATCH_PLAN.md`. All in `docs/_archive/`.
