...
- `docs/people/wesley_brief_onepager.md` — the one-pager Wesley brings to the escritura; key visual claims ("Paraguayan first", "low-impact", "62 ha") are backed by the assets selected here. wesley_brief_onepager is the message; §C feeds the imagery that supports the message.
