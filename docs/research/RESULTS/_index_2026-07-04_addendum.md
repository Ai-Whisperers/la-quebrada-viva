...
- [`PR04_bamboo_supply_paraguay`](./PR04_bamboo_supply_paraguay.md) — Native Guadua is strongest bamboo species, locally abundant, treatment required
- [`PR20_py_construction_market`](./PR20_py_construction_market.md) — Cement + steel +20-25% inflated 2024-2026; cost pillars validated

### Regional context (PR05-PR06)
- [`PR05_paraguarí_economy`](./PR05_paraguarí_economy.md) — Land-rich, labor-cheap, capital-scarce economy; local labor pool knowledge
- [`PR06_paraguay_climate_longterm`](./PR06_paraguay_climate_longterm.md) — Humid subtropical, +0.5-1°C warming since 1980, more extreme events
...
- [`PR08_py_insurance_companies`](./PR08_py_insurance_companies.md) — 5 PY insurers; need broker for eco-tourism; USD 8-15K/year
- [`PR11_py_restaurant_equipment`](./PR11_py_restaurant_equipment.md) — 5-6 PY distributors; 3-6 month lead time; USD 25-40K Phase 1
...
- [`PR16_py_food_supply_chain`](./PR16_py_food_supply_chain.md) — San Ber has organic producers; farm-to-table is achievable
...
1. **The cob/bamboo supply chain is real and local.** Both materials are available within 50 km of RV. No need to import.
2. **PY permit complexity is moderate, not severe.** Budget USD 15-25K for all Phase 1 permits; start 6 months before build.
3. **The primary market is EU expats in PY (30-50K pool), NOT EU tourists flying in.** This reframes the entire marketing strategy.
4. **San Bernardino is the supply + benchmarking anchor.** 45km away, established tourism infrastructure, German expat community.
...
|---|---|---|
| **Frameworks + processes** | ✅ All | — |
| **Range estimates** | ✅ Most | — |
| **2026 specific prices** | — | ❌ Need direct vendor outreach |
| **Vendor names + contacts** | Some | ❌ Need PY market introduction |
| **Personal relationships** | — | ❌ Need Wes/Kiki on-the-ground |

For the missing data: **Wes's W0.1-W1.2 actions (attorney call + PY site visit) are the unblockers**, not more research.
...
*Compiled by Erebus (AI Whisperers) on 2026-07-04.*
