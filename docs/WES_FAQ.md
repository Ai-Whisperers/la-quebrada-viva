# FAQ — Questions a First-Timer Asks

> **For anyone new to this repo — especially non-technical readers
...
Three audiences, with three different entry points:

| Audience | Start here |
|---|---|
| **Wesley / Thijs / family** | [`WES_INDEX.md`](./WES_INDEX.md) → [`POST_ESCRITURA_NOW.md`](./POST_ESCRITURA_NOW.md) |
| **Ivan / Kiki (AI Whisperers team)** | [`STATUS.md`](../STATUS.md) → [`CLAUDE.md`](../CLAUDE.md) |
| **Investor / partner (cold)** | [`wesley_brief_onepager.md`](./people/wesley_brief_onepager.md) + the 18 final PNGs |

## 3. What stage is the project at?

| Milestone | Date | Status |
|---|---|---|
| Boleto privado (private sale agreement) | 2026-04-28 | ✅ Signed |
| **Escritura (official title)** | **2026-06-27** | ✅ **Signed — 6 days ago** |
| Vision locked (5 audio recordings, 28K words) | 2026-06-30 | ✅ Captured |
| Sprint 0 research (8 materials topics) | 2026-06-30 | ✅ Done |
| **Wes's 5 actions this week** | **2026-07-15 target** | 🔴 Pending |
| NL+PY attorney call | 2026-07-15 target | 🔴 Pending |
...
**If you're Wes:** [`people/WES_ACTIONS.md`](./people/WES_ACTIONS.md) —
5 things only you can do this week. Print it, do the 5 things, mark ✅.

**If you're Ivan:** [`STATUS.md`](../STATUS.md) — current state.

**If you're a cold investor:** [`people/wesley_brief_onepager.md`](./people/wesley_brief_onepager.md) — the 1-pager. Then the 18 final PNGs in [`renders/`](../renders/).
...
Full narrative: [`audios/.../final/SYNTHESIS.md`](./audios/2026-06-30-wes-post-escritura/final/SYNTHESIS.md).
...
You don't need most of it. [`WES_INDEX.md`](./WES_INDEX.md) and
[`POST_ESCRITURA_NOW.md`](./POST_ESCRITURA_NOW.md) are 90% of what
anyone needs.
...
Rules (see [`sonia-assistant` skill](../CLAUDE.md) for full):
...
These govern everything. They're in
[`MASTER_BRIEF.md`](./_reconciled/MASTER_BRIEF.md) §14 and mirrored in
[`CLAUDE.md`](../CLAUDE.md):
...
2. **Decision-level disagreement** — open a discussion in
   [`docs/_reconciled/OPEN_DECISIONS.md`](./_reconciled/OPEN_DECISIONS.md).
...
- **The 5 things Wes does this week**: [`people/WES_ACTIONS.md`](./people/WES_ACTIONS.md)
- **What's blocking Phase 1**: [`POST_ESCRITURA_NOW.md`](./POST_ESCRITURA_NOW.md)
- **What Wes said across 5 audios**: [`audios/.../final/SYNTHESIS.md`](./audios/2026-06-30-wes-post-escritura/final/SYNTHESIS.md)
