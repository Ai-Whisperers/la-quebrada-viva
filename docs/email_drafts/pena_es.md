...
Adjunto el paquete técnico v-final correspondiente a la escritura de compraventa van de Camp / Torrasca, programada para hoy **27 de junio de 2026** en su escribanía.
...
2. **Bundle técnico completo** `wesley_bundle_20260616-1715.zip` (266 MB) — enviado por enlace separado dado el tamaño.
   ...
   - Manifiesto con hash por archivo en `wesley_bundle_20260616-1715.manifest.txt`.
   - Contiene: brief ejecutivo, deck completo, 18 renders finales (A/B/C × 6 vistas), gemelo digital del terreno 62 ha, cross-check DEM ALOS vs COP30, estudio de prefactibilidad Pelton, cómputo BoQ (CSV/MD/PDF), y carpeta de procedencia.

**Recordatorios contractuales para hoy:**

- **Cláusula CUARTA** — comprobante de fondos por **Gs. 2.252.700.000** a presentar en la mesa de firma. Los compradores lo traerán físicamente.
- **Cláusula OCTAVA (ii)** — los comprobantes a cargo de la parte vendedora vencen dentro de los **5 días hábiles** posteriores a la firma. Confirmamos seguimiento desde nuestro lado.
- **Comisión Sr. Burgos** — Gs. 313.000.000, abonada con el remanente de seña + top-up directo al momento de la firma (no requiere acción de la escribanía más allá de la constancia).
...
**Enlace separado:** bundle 266 MB + `.sha256` (Drive/WeTransfer — link a enviar 30 min antes)
