...
- **Site research**: [`docs/paraguay_clay_house_research.md`](../research/paraguay_context/paraguay_clay_house_research.md) (site-confirmed v2, authoritative)
- **Design brief**../_reconciled/MASTER_BRIEF.mdRIEF.md`](./MASTER_BRIEF.md) (zones, climate, flora, 10 rules)
...
For the T-7 / T-5 / T-2 / signing-day / T+30 day-by-day action sequence with a risk register, see [`CLOSING_DAY_PREP.md`](./CLOSING_DAY_PREP.md). For T+1 forward roadmap and Awasi / San Bernardino pa../state/DECISIONS.mdure, see [`DECISIONS.md`](../state/DECISIONS.md) entries dated 2026-06-28.
