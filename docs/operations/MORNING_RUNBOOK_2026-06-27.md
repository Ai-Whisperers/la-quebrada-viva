...
One-page mechanical checklist for the AI-side deliverables on signing day. Legal / contractual side is in [`CLOSING_DAY_PREP.md`](../legal/CLOSING_DAY_PREP.md); legal facts in [`contract_summar../legal/contract_summary.mdmary.md); pre-decided risk playbook in [`CONTINGENCIES.md`](./CONTINGENCIES.md); distribution mechanics in [`email_drafts/SHA../email_drafts/SHARE_LINKS.mdSHARE_LINKS.md); canonical artefact pins in [`../dist/print_pack_2026-06-27/INTEGRITY.md`](../dist/print_pack_2026-06-27/INTEGRITY.md). This file covers only what needs to happen on the laptop the morning of.
