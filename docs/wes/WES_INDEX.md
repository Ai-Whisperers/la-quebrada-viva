...
## 0. Where you are in the project

- ✅ **Escritura signed 2026-06-27** — the 62-ha land in Escobar, Paraguarí is yours (75%) + Thijs's (25%).
- ✅ **Vision locked** — 5 audio recordings on 2026-06-30 (3h 19m, 28,000 words) captured everything on your mind: housing park + restaurant + wellness pool + ceremonies + family-anchored community, 2030 horizon (Sonja's 60th).
- 🔵 **Next milestone:** the 5 things only you can do this week (see §3).

---

## 1. The 5-minute read (start here)
...
## 2. The dream + the action list (your own words, organized)

These are the 7 documents distilled from your 5 audios. They are the
**canon** for what you want, in order from vision → action:
...
## 4. What AI Whisperers already did (so you don't have to)

### 8 materials research results (Sprint 0, 2026-06-30)

Each is 2-4 KB, with sources + cost ranges + PY-specific notes.
...
## 5. The questions we still need YOU to answer (33 total)

Grouped by who's blocked waiting. **Read the bold ones first.**
...
4. **Toyota Tundra vs Presio** voor de bouwfase — finaliseren of
   verder onderzoeken?
5. **Railroad Ipoh-Karai**: onderzoeken of heb je een local contact?
...
## 6. What's NOT in this repo (the boundaries)

- ❌ **No personal data, no contracts, no escritura scans** — those are
  in private channels with Ivan.
- ❌ **No live financial model spreadsheet yet** — `FINANCIAL_MODEL.md` is
  the framework; numbers will fill in after W0.1 attorney call.
- ❌ **No drone LiDAR data yet** — needs a Py site visit (R42).
- ❌ **No actual photo of the 62 ha site yet** — placeholder image in
  `renders/site_overview/` until next visit.

---

## 7. How this repo is organized (for the technical-curious)

8 buckets, ~380 docs total. The 90% you don't need:

- `lqv/` — Blender 3D rendering code (Wes can ignore)
...
*Last build: 2026-07-03 · Commit: see top of repo*