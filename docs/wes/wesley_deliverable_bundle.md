...
9. **Day-by-day closing checklist** (A4 print of [`docs/CLOSING_DAY_PREP.md`](../legal/CLOSING_DAY_PREP.md) — T-7 / T-5 / T-2 / signing-day / T+30 sequence + risk register; for Wesley's own use, not handed to notary).
