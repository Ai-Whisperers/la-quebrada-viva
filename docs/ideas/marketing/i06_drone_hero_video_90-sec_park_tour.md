# I06: Drone hero video (90-sec park tour)
...
Video converts 5-10x better than photos for tourism. A drone flyover of the actual quebrada is Wes's strongest marketing asset and he doesn't have it yet.
...
- [`M03`](../marketing/m03_video_walkthrough_(90-sec_ken-burns_pan).md) — video
...
$300-800 (drone pilot + editor). Drone already in inventory if Wes has DJI.

## Done = shipped

Video live on YouTube + Instagram + site
