# A08: Moestuin (vegetable garden) + farmer partnership
...
veg_garden render + farmer contract template
...
- **Deliverable target:** veg_garden render + farmer contract template
...
- [`A09`](../_archive/2026-06-30_autofill/amenities/a09_speelbos_(play_forest)_for_kids.md) — play forest
- [`I11`](../amenities/i11_farm-to-table_pilot_1_vegetable_bed_and_1_chef_weekend.md) — chef weekend
