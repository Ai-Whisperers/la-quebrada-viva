# A04: Birthdays / family / corporate events
...
**Deliverable:** event lawn + reception

---

## What Wes wants

event lawn + reception

**From Wes's words:**

> _"[Dream list 2026-06-30]: rond de site** voor visuele referentie | Foto-album sync Wes → AI | Wesley + Google One | 🟡 Google One upgrade gestart vandaag | | D5 | **Bruiloften/verjaardagen/feesten/events** op de site | Event-amenity module | Erebus + Wesley | ⚪ Fase 2 (post-2027) | | D6 | **Wellness pools** — natuurwater, geen chloor | Eco-pool amenity module | Erebus | ⚪ Fase 2 | | D7 | **Romantische tafeltjes bij de quebrada** | S"_

> _"[Dream list 2026-06-30]: y) + Wesley (regenwater-systeem) | Fase 2 | | S3 | Bruiloften — exclusieve ceremonies met kapel/ruimte | Erebus + Wesley | Fase 2-3 | | S4 | Events — verjaardagen, familie-feesten, retreats | Erebus + Wesley | Fase 2-3 | | S5 | Eco-tourism — wandel-routes, vogelobservatie, medicinale planten-tour | Erebus + Wesley | Fase 3 | | S6 | VR-tour voor investeerders vóór de bouw | Erebus (3DGS pipeline) | Nu | | S7"_

> _"[Dream list 2026-06-30]: neel (Airbnb/Booking) | | 2027-H2 | Events-module operationeel | | 2028 | Restaurant, wellness pools | | **2030** | **Eerste Sonja-boeking voor 60ste verjaardag — volledig operationeel** | --- ## §6 — Onderzoeksmethode (Wes's proces, geformaliseerd) Wesley wil dat de AI dit patroon volgt voor elk idee: ``` 1. Idee (bv. "wellness pool") 2. Brainstorm 10-20 tangentieel-gerelateerde onderwerpen: - mater"_

> _"[Dream list 2026-06-30]: ** voor visuele referentie | Foto-album sync Wes → AI | Wesley + Google One | 🟡 Google One upgrade gestart vandaag | | D5 | **Bruiloften/verjaardagen/feesten/events** op de site | Event-amenity module | Erebus + Wesley | ⚪ Fase 2 (post-2027) | | D6 | **Wellness pools** — natuurwater, geen chloor | Eco-pool amenity module | Erebus | ⚪ Fase 2 | | D7 | **Romantische tafeltjes bij de quebrada** | Site-feat"_
...
- **Deliverable target:** event lawn + reception
...
- [`A03`](../amenities/a03_weddings_&_ceremonies_venue.md) — wedding venue
