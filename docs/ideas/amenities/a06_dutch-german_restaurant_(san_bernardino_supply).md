# A06: Dutch-German restaurant (San Bernardino supply)
...
restaurant_indoor + kitchen render

**From Wes's words:**

> _"[Action list 2026-06-30]: A1 | **Bamboe honing-kleur onderzoek** — kopen / groeien / importeren / termieten-behandeling | Web-research + leveranciers-vergelijking (Chaa Creek, San Bernardino Mennonieten) | Rapport + 3 offertes | | WA2 | **Bamboe-leveranciers in kaart brengen** | Database van Paraguayaanse bamboe-boeren | Lijst met contact | | WA3 | **Inboedel-onderzoek** — bedden, meubels, keuken — lokaal vs import (Troostwijk veilingen"_

> _"[Dream list 2026-06-30]: e typology gebouwd, eerste gasten verblijf | | 2027-Q2 | 3-6 huizen operationeel (Airbnb/Booking) | | 2027-H2 | Events-module operationeel | | 2028 | Restaurant, wellness pools | | **2030** | **Eerste Sonja-boeking voor 60ste verjaardag — volledig operationeel** | --- ## §6 — Onderzoeksmethode (Wes's proces, geformaliseerd) Wesley wil dat de AI dit patroon volgt voor elk idee: ``` 1. Idee (bv. "wellness"_
...
- **Deliverable target:** restaurant_indoor + kitchen render
...
- [`M02`](../marketing/m02_pr_push_to_german_dutch_expat_community_in_py.md) — PR
- [`I17`](../construction/i17_local_labor_exchange_with_san_bernardino_builders.md) — SB builders
- [`O09`](../_archive/2026-06-30_autofill/operations/o09_arborist_gardener_(native_plants_+_fruit_trees).md) — gardener
...
**Priority:** **Phase 3+ (year 2+) or nice-to-have.** Lowest priority.
