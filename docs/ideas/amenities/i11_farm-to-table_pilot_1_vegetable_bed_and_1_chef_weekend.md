# I11: Farm-to-table pilot (1 vegetable bed + 1 chef weekend)

**Category:** [Amenities](../amenities/README.md)
**Priority:** P2
**Owner:** Wesley
**Status:** `planned`
**Quality:** `✓ reviewed`
...
> _"[Raw transcript 2026-06-30]: kan het zien." > > "De muziek stopt." *(Opname 2 start)* > "In 2030 moet het in ieder geval goed lopend zijn. Want dan wil Sonja voor mij voor een weekend alle huisjes boeken." > > "Het komt half miljoen in. Nee, voor haar 60ste verjaardag of iets. O, maar dat komt goed." > > "Dan heb ik nog 4,5 jaar. Dat komt goed. Nee, 3,5 jaar." > > "3,5 jaar. Je bent al zo bekend dat je al 3,5 jaar vooruit moet bo"_

## Why this matters

Moestuin as standalone idea is too soft. A specific weekend format makes it operational. The chef-pipeline also opens the door to the Phase 3 Dutch-German restaurant (A06).
...
See related existing ideas: [`A08`](../amenities/a08_moestuin_(vegetable_garden)_+_farmer_partnership.md), [`A06`](../amenities/a06_dutch-german_restaurant_(san_bernardino_supply).md)
...
- [`A08`](../amenities/a08_moestuin_(vegetable_garden)_+_farmer_partnership.md) — moestuin
...
$500-2000 (seed + chef weekend). First chef might do it for free in exchange for media exposure.

## Done = shipped

5 paying guests for the second chef weekend

## Recommended next action

1. **Wes: review this suggestion** — accept / defer / reject with 1-line reason
2. **If accepted**: confirm priority (currently marked P2) + sprint slot
