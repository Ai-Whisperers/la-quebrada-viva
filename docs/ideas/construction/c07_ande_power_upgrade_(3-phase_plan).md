# C07: ANDE power upgrade (3-phase plan)
...
- **Deliverable target:** ANDE vs private subcontractor quotes
...
- **ANDE 3-phase upgrade process** — visit ANDE office in Paraguarí (closest to parcel)
- **Compare ANDE vs private subcontractor** — typical 3-phase upgrade is 4-8 months
- **Identify electrical engineer** — needed for the upgrade design
- **Cost range verification** — typical PY 3-phase upgrade $3-8k depending on distance
...
- [`I10`](../risk_mitigation/i10_insurance_broker_pre-qualification_before_breaking_ground.md) — insurance
