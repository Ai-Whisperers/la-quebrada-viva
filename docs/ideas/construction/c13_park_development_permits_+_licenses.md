# C13: Park development permits + licenses
...
- **Deliverable target:** permit checklist (Municipalidad, SENATUR, MADES, ANDE)
...
- [`C07`](../construction/c07_ande_power_upgrade_(3-phase_plan).md) — ANDE
