# C14: Gated vs open community (decision: open + minimal security)
...
DECISION: open + gate + camera, not full gated

**From Wes's words:**

> _"[Raw transcript 2026-06-30]: n alle andere projecten. Het is omdat ik het openbaar gebruik met klanten." > > "En mijn klanten zijn als een dentist. Een huishouding. Niet een cybersecurity dingetje." > > "Ja. Maar als je in je eigen VPS is. In je eigen instellingen." *(VPS architectuur uitleg, klant-isolatie)* > "Waar je de links doorgaat. Waar je je dingetje toevoegt. En dan." > > "Zeker in een jaar. Dat er een overgepowerde versie"_

> _"[Raw transcript 2026-06-30]: e man moet gewoon komen werken. Die man kreeg geld om in het huis te zitten. En een beetje opruimen." > > "En de koeien bijhouden. En als hij dan een hek moest plaatsen. Dan kreeg hij extra betaald." > > "Maar wij hebben geen oppas meer nodig. Wij willen hem gewoon betalen dat hij komt werken." > > "Dus dan wordt het een ander contract dan wat hij heeft. Maar dan moeten we even met hem over een discu"_
...
- **Deliverable target:** DECISION: open + gate + camera, not full gated
...
- [`R04`](../risk_mitigation/r04_minimal_security_(gate_+_camera,_not_full_gated).md) — security
...
**Status:** Wesley has made a decision on the direction. Action items may still be in motion.
