# C02: Honey-color bamboo impregnation
...
**Deliverable:** process + samples list

---

## What Wes wants

process + samples list
...
> _"[Raw transcript 2026-06-30]: om te importeren via Veilingen in Troostwijk. Bamboeleverosiers bekijken." > > "Hoe ze dit maken. Hoe ze dit behandelen tegen termieten. En in honingkleur kunnen krijgen." > > "Want dat is de kleur die ik wil hebben. Webresearch van hoe dat gedaan wordt. Alle werkwijzen." > > "Want je wil allemaal weten hoe dat werkt. Ja, en of ik het zo kan kopen. En of het moet groeien." > > "En of het moet importer"_
...
- **Deliverable target:** process + samples list
