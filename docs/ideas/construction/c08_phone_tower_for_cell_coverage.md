# C08: Phone tower for cell coverage
...
**Deliverable:** Tigo/Personal/Claro coverage map + tower options

---

## What Wes wants

Tigo/Personal/Claro coverage map + tower options
...
- **Deliverable target:** Tigo/Personal/Claro coverage map + tower options
...
- [`C09`](../construction/c09_starlink_vs_cellular_internet_decision.md) — internet
