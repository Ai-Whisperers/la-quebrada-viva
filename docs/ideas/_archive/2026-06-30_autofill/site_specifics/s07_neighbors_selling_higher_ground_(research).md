...
**Deliverable:** parcel-adjacent sale listings (not pushy)

---

## What Wes wants

parcel-adjacent sale listings (not pushy)
...
- **Deliverable target:** parcel-adjacent sale listings (not pushy)
...
- [`S06`](../site_specifics/s06_locate_13_typology-house_positions_(via_vr_+_site_.md) — placement
