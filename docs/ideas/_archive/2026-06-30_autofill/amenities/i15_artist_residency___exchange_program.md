# I15: Artist residency / exchange program
...
**Deliverable:** Quarterly invited artists (painters, sculptors, photographers) stay 1 month at RV in exchange for 1 artwork. Collection becomes a Wes-curated gallery.
...
Aligns with Wes's creative personality (stone shop, VR showroom aesthetic sense). Generates content + events + cultural credibility without cash outlay.
...
See related existing ideas: [`O18`](../operations/o18_hattie's_dog_rescue_instagram_(free_marketing).md), [`A09`](../amenities/a09_speelbos_(play_forest)_for_kids.md)
...
- [`O18`](../operations/o18_hattie's_dog_rescue_instagram_(free_marketing).md) — Hattie dogs
...
Free lodging x 4 artists/year = ~$15k opportunity cost

## Done = shipped

Collection shown at RV + sold (optional)

## Recommended next action

1. **Wes: review this suggestion** — accept / defer / reject with 1-line reason
2. **If accepted**: confirm priority (currently marked P3) + sprint slot
