# O05: Dutch reforestation guy in Caacupé (10-15yr native species)
...
**Deliverable:** contact info + meeting scheduled

---

## What Wes wants

contact info + meeting scheduled
...
- **Deliverable target:** contact info + meeting scheduled
...
- Wes mentioned the Dutch guy by name region (Caacupé)
- Caacupé is 50km from Asunción, traditional German-influenced town
- Mennonite colonies in Loma Plata + Filadelfia also do reforestation
- 1 phone call from Wes = this is not research, it's contact

## What needs research

- **Identify the Caacupé reforestation guy** — Wes needs to share the name
- **Find Mennonite reforestation projects** — Loma Plata has 15+ yr programs
- **Contact San Bernardino German-community environmental groups**
- **Validate his 10-15yr claim** — call and verify

## Dependencies

**This idea depends on / is informed by:**

- [`A07`](../amenities/a07_atlantic_forest_regeneration_partnership.md) — Atlantic Forest
- [`S02`](../site_specifics/s02_eco_positioning_(not_'ecopark'_-_politically_loade.md) — eco framing
