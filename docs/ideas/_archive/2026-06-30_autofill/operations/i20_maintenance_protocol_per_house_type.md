# I20: Maintenance protocol (per house type)
...
Wes's catalog assumes houses are "done" after build. They're not. A maintenance protocol prevents the slow decay that makes a property look tired in 3 years and derelict in 7.
...
- [`T01`](../house_typologies/t01_type_a_—_romantic_2p_(30-40_m²).md) — typology
...
$0 (Erebus drafts from existing material specs)

## Done = shipped

First house follows the protocol for 1 year with zero surprises
