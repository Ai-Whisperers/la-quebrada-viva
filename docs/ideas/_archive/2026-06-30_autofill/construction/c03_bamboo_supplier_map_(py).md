...
**Deliverable:** supplier database + contact info

---

## What Wes wants

supplier database + contact info
...
- **Deliverable target:** supplier database + contact info
...
- **Map of bamboo growers in PY** — focus on Loma Plata + Filadelfia Mennonite colonies + San Bernardino German-community farms
- **Compare per-lineal-meter pricing** — fresh-cut vs dried vs treated
- **Visit + ask model**: 2-day trip to Loma Plata, talk to 2-3 growers
- **Identify bulk supplier vs retail** — for 100+ lineal meters/month

## Dependencies

**This idea depends on / is informed by:**

- [`C01`](../construction/c01_bamboo_+_wood_termite_treatment.md) — treatment
- [`I17`](../construction/i17_local_labor_exchange_with_san_bernardino_builders.md) — SB builders
