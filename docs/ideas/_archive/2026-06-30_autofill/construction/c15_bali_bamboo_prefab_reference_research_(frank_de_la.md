# C15: Bali bamboo prefab reference research (Frank de Laat)
...
**Deliverable:** prefab supplier list + design references

---

## What Wes wants

prefab supplier list + design references
...
- **Deliverable target:** prefab supplier list + design references
...
- [`C03`](../construction/c03_bamboo_supplier_map_(py).md) — supplier
