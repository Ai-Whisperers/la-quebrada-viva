# C01: Bamboo + wood termite treatment
...
**Deliverable:** treatment-options memo + PY supplier list

---

## What Wes wants

treatment-options memo + PY supplier list
...
- [Insight #2: The bamboo-supply decision has a 6-month lead time](../INSIGHTS.md) — _The bamboo-supply decision has a 6-month lead time_
...
- **Deliverable target:** treatment-options memo + PY supplier list
...
- NL prices doc: bamboo not yet priced line-by-line
- Sketchfab CC-BY assets exist for some bamboo species (Guadua) — 3D models available
- Boric acid termite treatment is the global gold standard
- 4-8 week soak/dry process per batch

## What needs research

- **Mennonite colony bamboo suppliers (Loma Plata, Filadelfia)** — source: ASCIM (Asociación de Servicios de Cooperación Indígena-Mennonita) directory
- **Boric acid bulk suppliers in PY** — source: agro-vet distributors (Agrofértil, Grupo Guerrero)
- **3-day DIY treatment trial** — validate process before committing to all houses
- **Bamboo CCA vs boric acid comparison** — which holds up in PY humidity?

## Dependencies

**This idea depends on / is informed by:**

- [`C02`](../construction/c02_honey-color_bamboo_impregnation.md) — honey color
- [`C03`](../construction/c03_bamboo_supplier_map_(py).md) — bamboo supplier
