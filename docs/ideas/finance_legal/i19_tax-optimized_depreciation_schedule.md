# I19: Tax-optimized depreciation schedule
...
A park with $250-500k of equipment + $300k+ of structures has real depreciation value. The right schedule saves 5-10% in effective tax over 5 years.
...
See related existing ideas: [`F11`](../finance_legal/f11_tax_advisor_consultation_(nl_+_py).md), [`F01`](../finance_legal/f01_4-entity_bv_cascade_(land_py_+_finance_nl_+_phase_.md)
...
$500-2000 (tax advisor)

## Done = shipped

Schedule filed with first-year accounts
