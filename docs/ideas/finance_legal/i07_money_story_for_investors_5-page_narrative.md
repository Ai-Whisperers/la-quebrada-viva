# I07: Money story for investors (5-page narrative)
...
Decks sell fantasies. Stories sell decisions. European investors (esp. NL) respond to written narrative + numbers, not slides. Wes's target investor profile is 40-65 year old, mid-six-figures, looking for lifestyle + modest return. That audience reads.
...
See related existing ideas: [`F08`](../finance_legal/f08_first-pass_cost_estimate_(whole_project).md), [`F09`](../finance_legal/f09_investor_pitch_deck.md), [`F07`](../finance_legal/f07_investor_circles_(concentric_tiers).md)
...
- [`F08`](../finance_legal/f08_first-pass_cost_estimate_(whole_project).md) — cost estimate
...
$0 (Erebus can draft from existing materials)

## Done = shipped

Sent to 10 warm contacts; 3 meetings booked
