# B02: Interactive site-placement tool (move houses 5m)
...
**Deliverable:** live site map with drag-drop typology slots

---

## What Wes wants

live site map with drag-drop typology slots

**From Wes's words:**

> _"[Action list 2026-06-30]: dere bv's NL vs PY, wanneer verplicht | Onderzoek belastingadvies NL + PY | Memo + contacten | | WA6 | **VR/3D interactief prototype** — site-map met verplaatsbare huizen | Bouwen op lqv-walkthrough.pages.dev | Live demo | | WA7 | **Marketing-plan voor 1e-huur-huizen** (Booking.com + Airbnb + niche) | Onderzoek + template listings | Template + strategy | | WA8 | **Google One upgrade uitvoeren** | Handleidi"_

> _"[Dream list 2026-06-30]: geldig, niet hallucinaties) | # | Wens | Werkelijk doel | Wie kan het | Status | |---|---|---|---|---| | D1 | **3D/VR site placement tool** — huizen verplaatsen op satelliet, 5m, andere kant, grotere veranda | Interactieve LQV-site-map met typology-plaatsing | Erebus / Hermes | ✅ Reeds lopend via `lqv-walkthrough.pages.dev` | | D2 | **VR-bril walkthrough** — investeerder/koper loopt virtueel door huis | B"_

> _"[Dream list 2026-06-30]: ) | # | Wens | Werkelijk doel | Wie kan het | Status | |---|---|---|---|---| | D1 | **3D/VR site placement tool** — huizen verplaatsen op satelliet, 5m, andere kant, grotere veranda | Interactieve LQV-site-map met typology-plaatsing | Erebus / Hermes | ✅ Reeds lopend via `lqv-walkthrough.pages.dev` | | D2 | **VR-bril walkthrough** — investeerder/koper loopt virtueel door huis | Buyer-facing 3DGS vi"_

> _"[Dream list 2026-06-30]: - ## §1 — Visie / droom (geldig, niet hallucinaties) | # | Wens | Werkelijk doel | Wie kan het | Status | |---|---|---|---|---| | D1 | **3D/VR site placement tool** — huizen verplaatsen op satelliet, 5m, andere kant, grotere veranda | Interactieve LQV-site-map met typology-plaatsing | Erebus / Hermes | ✅ Reeds lopend via `lqv-walkthrough.pages.dev` | | D2 | **VR-bril walkthrough** — investeerder/koper lo"_
