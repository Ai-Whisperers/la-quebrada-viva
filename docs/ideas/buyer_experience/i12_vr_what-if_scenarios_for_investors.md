# I12: VR "what-if" scenarios for investors

**Category:** [Buyer Experience](../buyer_experience/README.md)
**Priority:** P1
**Owner:** Erebus
**Status:** `planned`
**Quality:** `✓ reviewed`
...
See related existing ideas: [`B01`](../buyer_experience/b01_vr_walkthrough_before_building.md), [`F09`](../_archive/2026-06-30_autofill/finance_legal/f09_investor_pitch_deck.md)
...
- [`B01`](../buyer_experience/b01_vr_walkthrough_before_building.md) — VR base
...
$500-1500 (Erebus builds from existing 3DGS + render assets)

## Done = shipped

Investor deck embeds the 3 scenarios; 5 investor meetings use them
