# B05: VR with local wildlife as ambient (lapacho, jaguar, birds)
...
asset library: native fauna (passive, not interactive game animals)
...
- **Deliverable target:** asset library: native fauna (passive, not interactive game animals)
...
- [`A07`](../_archive/2026-06-30_autofill/amenities/a07_atlantic_forest_regeneration_partnership.md) — Atlantic Forest
