# O03: Cow takeover (terrain maintenance)
...
purchase + new worker contract

**From Wes's words:**

> _"[Action list 2026-06-30]: ** voor eerste maanden | Week 2-3 | Wesley | | T7 | **Locatie onderzoeken** voor de 13 typologie-huizen | Maand 1-2 | Wesley + Erebus | --- ## §5 — KOEIEN-OVERNAME (terreinonderhoud) | # | Taak | Wanneer | Owner | |---|---|---|---| | K1 | In gesprek met oude eigenaar over overname koeien | Week 2 | Wesley | | K2 | Inschatten waarde + gezondheid kudde | Week 3 | Wesley + dierenarts | | K3 | Afronden o"_

> _"[Action list 2026-06-30]: ructuur advies (WA5) | Erebus → Wesley | | 6 | VR-prototype update (E3) | Erebus | | 7 | Locaties typologie-huizen (T1, T7) | Wesley + Erebus | | 8 | Koeien-overname (K1-K4) | Wesley | | 9 | Jos + Thijs onboarding (T6) | Wesley | | 10 | Onderzoeksmethode-skill bouwen (E1) | Erebus | --- ## §10 — RISICO'S / AANDACHTSPUNTEN 1. **Culturele sensitiviteit** — Wesley wees expliciet op NL-direct vs PY-indir"_

> _"[Action list 2026-06-30]: Week 2 | Wesley | | K2 | Inschatten waarde + gezondheid kudde | Week 3 | Wesley + dierenarts | | K3 | Afronden overname + nieuwe contract medewerker (vee + terrein) | Week 4 | Wesley + Sonja | | K4 | Terreinonderhoud-schema (weide, water, gezondheid) | Lopend | Nieuwe medewerker | --- ## §6 — FINANCIEEL / INVESTEERDERS | # | Taak | Wanneer | Owner | |---|---|---|---| | F1 | **Prijsraming voor plan"_

> _"[Dream list 2026-06-30]: rs vóór de bouw | Erebus (3DGS pipeline) | Nu | | S7 | Lokaal personeel in dienst (Jos, Thijs, plus nieuwe medewerker) | Wesley + Sonja | Nu | | S8 | Koeien overnemen van oude eigenaar (terreinonderhoud) | Wesley + nieuwe medewerker | Komende maanden | --- ## §5 — Tijdlijn (geldig) | Datum | Mijlpaal | |---|---| | 2026-06-27 | Escritura getekend ✅ | | 2026-06-30 | Eerste prijzen-doc, NL versie ✅ | |"_
...
- **Deliverable target:** purchase + new worker contract
...
- [`O08`](../operations/o08_farmer_(terrain_maintenance).md) — farmer
