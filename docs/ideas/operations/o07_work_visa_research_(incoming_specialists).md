# O07: Work visa research (incoming specialists)
...
**Deliverable:** PY visa types + costs + durations

---

## What Wes wants

PY visa types + costs + durations
...
- [Insight #15: Where Erebus can't help (and shouldn't pretend to)](../INSIGHTS.md) — _Where Erebus can't help (and shouldn't pretend to)_
...
- **Deliverable target:** PY visa types + costs + durations
...
- [`O04`](../operations/o04_local_craftsmen_hiring_(carpenters,_masons,_electr.md) — craftsmen
