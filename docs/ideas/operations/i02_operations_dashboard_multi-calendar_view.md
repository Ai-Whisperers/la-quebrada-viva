# I02: Operations dashboard (multi-calendar view)
...
> _"[Dream list 2026-06-30]: "Onderzoek hoe bamboe honing-kleur te krijgen" | Specifieke web-research + Paraguay-leveranciers | | A11 | "Vergelijk offertes ANDE vs particulier" | Multi-source prijsonderzoek, rapport in markdown | | A12 | "Onderzoek of ik bamboe kan kopen, importeren of zelf groeien" | Supply-chain research | | A13 | "Maak een lijst van mijn stappen" | Personal CRM / actielijst met deadlines | | A14 | "Stuur berich"_

## Why this matters

When Wes has 5+ houses + events + maintenance windows, the mental load of "what's free when" becomes its own job. A dashboard beats a spreadsheet.
...
See related existing ideas: [`I01`](../operations/i01_reservation_widget_and_whatsapp_handoff.md), [`I14`](../operations/i14_off-season_pricing_strategy.md)
...
- [`I14`](../operations/i14_off-season_pricing_strategy.md) — pricing
...
$1000-3000 (custom build) OR existing tools like Lodgify / OwnerRez ($30-50/mo)

## Done = shipped

Calendar view showing 12 months x all units; booking pipeline visualization; export to CSV
