# O09: Arborist/gardener (native plants + fruit trees)
...
**Deliverable:** job description + candidate search

---

## What Wes wants

job description + candidate search
...
- **Deliverable target:** job description + candidate search
...
- [`O05`](../operations/o05_dutch_reforestation_guy_in_caacupé_(10-15yr_native.md) — reforestation
