...
/research slash command in Hermes
...
- **Deliverable target:** /research slash command in Hermes
...
- [`O11`](../operations/o11_ai_'wish_genie'_assistant_(open-ended_ideation).md) — wish genie
