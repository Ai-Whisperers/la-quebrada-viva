...
> - [`catalogue.json`](./catalogue.json) — machine-readable for tooling (343 KB)
> - [`by_asset/`](./by_asset/) — per-asset drill-down (one .md per render asset, 53 files)
> - [`contact_sheets/`](./contact_sheets/) — visual contact sheets (53 PNGs)
